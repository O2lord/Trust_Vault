// app/api/payment-processors/opay/seller-credentials/toggle/route.ts
//
// Activates or deactivates an OPay seller credential.
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (error) {
      console.error('[OPay] DB error toggling seller credential:', error);
    ...
    console.error('[OPay] Error toggling seller credential:', error);
