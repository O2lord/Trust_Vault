// app/api/payment-processors/korapay/buyer-credentials/store/route.ts
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (error) {
      console.error('[Korapay] DB error storing buyer credentials:', error);
    ...
    return NextResponse.json({
      ...
      message: 'Korapay buyer credentials stored successfully',
    });
  } catch (error) {
    console.error('[Korapay] Error storing buyer credentials:', error);
