// api/flutterwave/seller-credentials/status/route.ts
  ...
  try {
    ...
    return NextResponse.json({
      ...
      message: credentialCheck.valid
        ...
        : 'Seller credentials are invalid or expired',
    });
  } catch (error) {
    console.error('Error checking seller credential status:', error);
    return NextResponse.json(
