...
const CancelorReduceButton: React.FC<Props> = ({ trustExpress, vaultBalance, disabled }) => {
  const queryClient = useQueryClient();
  const { cancelOrReduceBuyOrder } = useTrustExpress();
  ...
  }, [trustExpress, newAmount, vaultBalance, queryClient, cancelOrReduceBuyOrder]);
